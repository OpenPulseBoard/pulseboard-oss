...
| `kill-mimir-ingester.sh` | Mimir ingester (metrics storage) | Probe metric visible within **120 s** |
...
| Mimir data recovery | < 120 s data visible | `kill-mimir-ingester.sh` probe |
